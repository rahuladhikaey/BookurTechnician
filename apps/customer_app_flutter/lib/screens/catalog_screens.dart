      ...
      child: Padding(
        ...
        child: Row(children: [
          Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            const SizedBox(height: 4),
            Builder(builder: (_) {
              final hasLoc = state.hasValidLocation;
              final count = state.getServiceAvailabilityCount(service.id);
              final hasTechs = hasLoc && count > 0;
              final availText = state.getServiceAvailabilityText(service.id);
              final isRefreshing = state.isServiceRefreshing(service.id);
              return Material(
                color: Colors.transparent,
                child: InkWell(
                  onTap: () {
                    HapticFeedback.lightImpact();
                    ref.read(bookingProvider.notifier).refreshServiceAvailabilityWithLiveLocation(service.id);
                  },
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        if (isRefreshing)
                          ...
                          const Icon(Icons.refresh_rounded, size: 12, color: Color(0xFF64748B)),
                      ],
                    ),
                  ),
                ),
          ...
          ElevatedButton(
            ...
            child: Text(inCart ? 'Remove' : 'Add', style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 13)),
          ),
        ]),
      ),
    );
...
class _ServiceDetailScreenState extends ConsumerState<ServiceDetailScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ref.read(bookingProvider.notifier).fetchSingleServiceAvailability(widget.serviceId);
      ref.read(bookingProvider.notifier).fetchNearbyAvailability();
    });
  }
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    Container(
                      ...
                      child: const Row(
                        children: [
                          Icon(Icons.verified, color: Color(0xFF0284C7), size: 14),
                          SizedBox(width: 4),
                          Text(
                            'Verified',
                            style: TextStyle(
                ...
                // 2. Real-Time Spatial Availability Status with Interactive Reload Button
                ...
                // 4. What Service Includes Section
                _buildInclusionsSection(),
                const SizedBox(height: 28),

                // 5. Does Not Include Section
                _buildExclusionsSection(),
                const SizedBox(height: 28),

                // 6. How It's Done Section
  ...
  Widget _buildNearbyTechniciansSection(BuildContext context, WidgetRef ref, ServiceItem service) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: hasTechs ? const Color(0xFFECFDF5) : const Color(0xFFF8FAFC),
        ...
        boxShadow: [
          BoxShadow(
            color: (hasTechs ? const Color(0xFF059669) : Colors.black).withValues(alpha: 0.04),
            blurRadius: 10,
      ...
      child: Row(
        ...
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              color: hasTechs ? const Color(0xFF059669) : const Color(0xFF64748B),
              shape: BoxShape.circle,
              boxShadow: [
                BoxShadow(
                  color: hasTechs ? const Color(0x40059669) : Colors.black12,
                  blurRadius: 6,
          ...
          Expanded(
            child: Column(
              ...
              children: [
                    ...
                    Flexible(
                      child: Text(
                        ...
                        style: TextStyle(
                          ...
                          fontSize: 13,
                          color: hasTechs ? const Color(0xFF065F46) : const Color(0xFF334155),
                        ),
                        maxLines: 2,
                        overflow: TextOverflow.ellipsis,
                      ),
                ...
                Text(
                  hasTechs
                      ? 'Automated nearest technician dispatch upon booking confirmation'
                      : 'Real-time PostGIS radius scan active (15 km)',
                  style: TextStyle(
                    fontSize: 11,
                    color: hasTechs ? const Color(0xFF047857) : const Color(0xFF64748B),
              ...
              Material(
                ...
                child: InkWell(
                  onTap: isRefreshing
                      ...
                      : () async {
                          ...
                          final updatedCount = await ref
                              ...
                              .refreshServiceAvailabilityWithLiveLocation(service.id);
                          if (context.mounted) {
                            ScaffoldMessenger.of(context).hideCurrentSnackBar();
                            final isSuccess = updatedCount != null && updatedCount > 0;
                                ...
                                content: Row(
                                  children: [
                                    ...
                                    Expanded(
                                      child: Text(
                                        isSuccess
                                            ? '$updatedCount technician${updatedCount > 1 ? 's' : ''} online within 15 km'
                                            : 'No technicians currently online within 15 km',
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      color: hasTechs ? const Color(0xFF059669) : const Color(0xFF1E293B),
                      borderRadius: BorderRadius.circular(20),
                      boxShadow: [
                        BoxShadow(
                          color: (hasTechs ? const Color(0xFF059669) : Colors.black).withValues(alpha: 0.2),
                          blurRadius: 4,
                        ...
                        ElevatedButton(
                          onPressed: isProcessing
                              ...
                              : () async {
                                  ...
                                  final targetBookingId = booked?.id ?? code;

                                  // Direct Dispatch to Live Tracking Page (100% Real GPS & PostGIS Stream)
                                  Navigator.push(
                                    context,
                                    MaterialPageRoute(

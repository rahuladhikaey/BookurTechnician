...
-- ─── OPTIONAL: RESET / DELETE ALL OLD DATABASE TABLES (UNCOMMENT TO RESET) ──
/*
-- METHOD 1: COMPLETE PUBLIC SCHEMA RESET (RECOMMENDED FOR SUPABASE & CLEAN INSTALL)
...
/*
-- METHOD 2: EXPLICIT DROP ALL TABLES WITH CASCADE
...
DROP TABLE IF EXISTS technician_wallets CASCADE;
...
DROP TABLE IF EXISTS skill_service_compatibilities CASCADE;
DROP TABLE IF EXISTS service_skills CASCADE;
DROP TABLE IF EXISTS service_brand_models CASCADE;
DROP TABLE IF EXISTS service_brands CASCADE;
DROP TABLE IF EXISTS service_items CASCADE;
DROP TABLE IF EXISTS service_categories CASCADE;
DROP TABLE IF EXISTS customer_addresses CASCADE;
DROP TABLE IF EXISTS customer_profiles CASCADE;
DROP TABLE IF EXISTS dispatch_matching_configs CASCADE;
